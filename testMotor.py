...
class Motor():
    ...
    def goto(self,speed,distance):
        return self.dxl_io.set_speed_left_wheels(speed),self.dxl_io.set_speed_right_wheels(-speed),
        time.sleep(distance/speed),self.set_speed_right_wheels(0),self.set_speed_left_wheels(0)
